  ...
  return {
    ...
    execute: function () {
      ...
      _export("FrameManager", FrameManager = (_dec = ccclass('FrameManager'), _dec2 = property({
        ...
        setAnim(animName, angle, loopCount) {
          if (loopCount === void 0) {
            loopCount = -1;
          }
        ...
        _setAnim(animName, angle) {
          ...
          var sf = (_crd && FrameAnimManager === void 0 ? (_reportPossibleCrUseOfFrameAnimManager({
            error: Error()
...
//# sourceMappingURL=8354ac407215243163174d3e83d4cdab306051e3.js.map