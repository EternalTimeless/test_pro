      ...
      _export("PropArms", PropArms = (_dec11 = ccclass('PropArms'), _dec12 = property({
          ...
          var _loop = function _loop() {
            ...
            tween(tire).delay(i * 0.05).to(0.07, {
              ...
              (_crd && PoolManager === void 0 ? (_reportPossibleCrUseOfPoolManager({
                error: Error()
              }), PoolManager) : PoolManager).instance.setPool(_this.bottomBasePoolKey, tire);
            }).start();
          };
        ...
        _playBottomTireHit() {
          ...
          var _loop2 = function _loop2() {
            ...
            _this2.playBottomBaseGoldWrap(tire); // const s1 = PoolManager.instance.V3.set(Vec3.ONE);
        ...
        playBottomBaseGoldWrap(tire) {
          var meshRenderer = this.findFirstMeshRenderer(tire);
        ...
        init(count) {
          ...
          if (this._level >= this.armsInfoList.length) {
            ...
            for (var _i4 = 0; _i4 < tireCount; _i4++) {
              ...
              var tireY = this.getBottomBaseTargetY(_i4);
