  ...
  return {
    ...
    execute: function () {
      ...
      _export("CollectBattleTarger3D", CollectBattleTarger3D = (_dec = ccclass('CollectBattleTarger3D'), _dec(_class = class CollectBattleTarger3D extends (_crd && TriggerBase3D === void 0 ? (_reportPossibleCrUseOfTriggerBase3D({
        ...
        _startCollide(event) {
          var battle = event.otherCollider.getComponent(_crd && BattleTarget3D === void 0 ? (_reportPossibleCrUseOfBattleTarget3D({
            error: Error()
        ...
        groupTarget_scope(angle, rot) {
          var groupList = this.groupTarget;

          if (this.groupTarget) {
            this._tempTargetList.length = 0;
            Vec3.transformQuat(this._fowerVe3, Vec3.FORWARD, rot);
            var pos = this.node.getWorldPosition(this._vector);

            for (var i = 0; i < groupList.length; i++) {
              var target = groupList[i];
              var v = (_crd && vectorPower2 === void 0 ? (_reportPossibleCrUseOfvectorPower({
                error: Error()
...
//# sourceMappingURL=1193ac27b94da532d27808ef712ed0fcd809d84d.js.map