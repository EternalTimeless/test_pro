    ...
    execute: function () {
      ...
      _export("EffectManager", EffectManager = (_dec = ccclass('EffectManager'), _dec(_class = class EffectManager extends (_crd && Singleton === void 0 ? (_reportPossibleCrUseOfSingleton({
        ...
        canShowEffect(type) {
          ...
          var max = this._maxShowCountByType[type];

          if (!max || max <= 0) {
            return true;
          }

          var showing = (_this$_effectShowList = (_this$_effectShowList2 = this._effectShowListL[type]) == null ? void 0 : _this$_effectShowList2.length) != null ? _this$_effectShowList : 0;
          var queued = (_this$_effectListL$ty = (_this$_effectListL$ty2 = this._effectListL[type]) == null ? void 0 : _this$_effectListL$ty2.length) != null ? _this$_effectListL$ty : 0;
          return showing + queued < max;
        }

        trackShowingEffect(effect, type) {
          var er = effect.getComponent(_crd && EffectTimePartRemove === void 0 ? (_reportPossibleCrUseOfEffectTimePartRemove({
            error: Error()
...
//# sourceMappingURL=b0316da27abe29af9f8a517d28257bc913762f57.js.map