  ...
  return {
    ...
    execute: function () {
      ...
      _export("JumpManager", JumpManager = class JumpManager extends (_crd && Singleton === void 0 ? (_reportPossibleCrUseOfSingleton({
        ...
        jumpCurve(flyNode, endPosTemp, jumpSpeed, jumpPower) {
          if (jumpSpeed === void 0) {
            jumpSpeed = 1;
          }
        ...
        jumpCurve2D(flyNode, endPosTemp, jumpSpeed, jumpPower) {
          if (jumpSpeed === void 0) {
            jumpSpeed = 1;
          }
          ...
          var propdata = (_crd && PoolManager === void 0 ? (_reportPossibleCrUseOfPoolManager({
            error: Error()
        ...
        */
        ...
        jumpCurve3D(flyNode, endPosTemp, jumpSpeed, jumpPower) {
          if (jumpSpeed === void 0) {
            jumpSpeed = 1;
          }
        ...
        bezierCurve(flyNode, points, jumpSpeed) {
          if (jumpSpeed === void 0) {
            jumpSpeed = 1;
          }
        ...
        jumpBezierCurve(flyNode, endPosTemp, jumpSpeed, jumpPower) {
          if (jumpSpeed === void 0) {
            jumpSpeed = 1;
          }
          ...
          var startPos = flyNode.worldPosition;
          var endPos = endPosTemp;
          var centerPos = new Vec3();
          ...
          if ((_crd && LayerManager === void 0 ? (_reportPossibleCrUseOfLayerManager({
            ...
            var points = [new Float32Array([startPos.x, startPos.y]), new Float32Array([centerPos.x, centerPos.y]), new Float32Array([endPos.x, endPos.y])];
            propdata.init(flyNode, points, jumpSpeed);
          } else {
            centerPos.y += 8 * jumpPower;
            var _points = [new Float32Array([startPos.x, startPos.y, startPos.z]), new Float32Array([centerPos.x, centerPos.y, centerPos.z]), new Float32Array([endPos.x, endPos.y, endPos.z])];
            propdata.init(flyNode, _points, jumpSpeed);
          }
        ...
        */
        ...
        jumpBezierByPoints(flyNode, jumpSpeed) {
          if (jumpSpeed === void 0) {
            jumpSpeed = 1;
          }

          var startPos = flyNode.worldPosition;
          var is2D = (_crd && LayerManager === void 0 ? (_reportPossibleCrUseOfLayerManager({
            error: Error()
          }), LayerManager) : LayerManager).instance.SceneType == (_crd && SceneType === void 0 ? (_reportPossibleCrUseOfSceneType({
            error: Error()
          }), SceneType) : SceneType).D2;
          var startVec = is2D ? new Float32Array([startPos.x, startPos.y]) : new Float32Array([startPos.x, startPos.y, startPos.z]);

          for (var _len = arguments.length, waypoints = new Array(_len > 2 ? _len - 2 : 0), _key = 2; _key < _len; _key++) {
            waypoints[_key - 2] = arguments[_key];
          }
        ...
        jumpParabola(flyNode, endPos, jumpHeight, jumpSpeed) {
        ...
        jumpScatter(flyNode, endPos, jumpHeight, jumpSpeed, scatterAngle) {
          if (jumpHeight === void 0) {
            jumpHeight = 1;
          }
        ...
        jumpScatterBatch(nodes, endPos, jumpHeight, jumpSpeed, scatterRadius, randomness, delayStep) {
          if (jumpHeight === void 0) {
            jumpHeight = 1;
          }
        ...
        JumpCurveTime(propList, endPosTemp, count, time, curve, curveSpeed) {
          if (curve === void 0) {
            curve = null;
          }

          if (curveSpeed === void 0) {
            curveSpeed = null;
          }
...
//# sourceMappingURL=c974e8abbefe95ced447fbcfef18a7ca5af0d0cb.js.map