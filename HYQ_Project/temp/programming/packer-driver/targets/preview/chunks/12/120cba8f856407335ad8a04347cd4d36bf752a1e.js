System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10", "__unresolved_11", "__unresolved_12", "__unresolved_13", "__unresolved_14", "__unresolved_15"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, CCBoolean, CCFloat, CCInteger, Node, Quat, Tween, tween, Vec3, MoveDrive, Role, getCirclePosition, ArmsTypeEnum, BulletEnum, EventType, LayerEnum, PoolEnum, PrefabsEnum, RoleEnum, SoundEnum, PoolManager, EventManager, PrefabsManager, TweenTool, GameOverPanel, UnityUpComponent, AudioManager, BulletManager, FlashRedManager, BulletBatchRenderer, LayerManager, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _dec16, _dec17, _dec18, _dec19, _dec20, _dec21, _dec22, _class4, _class5, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _descriptor12, _descriptor13, _descriptor14, _descriptor15, _descriptor16, _descriptor17, _descriptor18, _descriptor19, _descriptor20, _class6, _crd, ccclass, property, WeaponBulletConfig, PlayerFBXAnimName, Player;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("Player", Player = (_dec9 = ccclass('Player'), _dec10 = property(_crd && Role === void 0 ? (_reportPossibleCrUseOfRole({
      ...
      }), _dec20 = property(CCBoolean), _dec21 = property({
        type: [WeaponBulletConfig],
        displayName: '武器子弹配置',
        tooltip: '配置各武器的子弹威力和子弹模型。'
      }), _dec22 = property(Node), _dec9(_class4 = (_class5 = (_class6 = class Player extends (_crd && UnityUpComponent === void 0 ? (_reportPossibleCrUseOfUnityUpComponent({
        error: Error()
        ...
        constructor() {
          ...
          _initializerDefineProperty(this, "outerLayerRoleCount", _descriptor11, this);

          _initializerDefineProperty(this, "shrinkAfterRoleLossDelay", _descriptor12, this);

          _initializerDefineProperty(this, "maxShootingRoleCount", _descriptor13, this);

          _initializerDefineProperty(this, "maxMuzzleEffectCount", _descriptor14, this);

          _initializerDefineProperty(this, "staggerShotWeaponConfigIndex", _descriptor15, this);

          _initializerDefineProperty(this, "staggerShotWindowRatio", _descriptor16, this);

          _initializerDefineProperty(this, "defaultWeaponConfigIndex", _descriptor17, this);

          _initializerDefineProperty(this, "enableRuntimeUpgradePrewarm", _descriptor18, this);

          _initializerDefineProperty(this, "weaponBulletConfigList", _descriptor19, this);
          ...
          _initializerDefineProperty(this, "shootList", _descriptor20, this);
        ...
        getRoleLayer(index) {
          ...
          var layer = 0;
          var indexInLayer = effectiveIndex;
          var layerCount = this.getRoleLayerCount(layer);
        ...
        upArms(armwType, weaponBulletConfigIndex) {
          var _weaponBulletConfig$a;

          if (weaponBulletConfigIndex === void 0) {
            weaponBulletConfigIndex = -1;
          }
        ...
        prepareArmsUpgrade(armwType, weaponBulletConfigIndex) {
          ...
          var weaponBulletConfig = this.getWeaponBulletConfig(armwType, weaponBulletConfigIndex);
          var upgradeArmsType = (_weaponBulletConfig$a2 = weaponBulletConfig == null ? void 0 : weaponBulletConfig.armsType) != null ? _weaponBulletConfig$a2 : armwType;
          ...
          var soundType = this.getSoundTypeByArms(upgradeArmsType);
          ...
          var bulletType = (_weaponBulletConfig$b = weaponBulletConfig == null ? void 0 : weaponBulletConfig.bulletType) != null ? _weaponBulletConfig$b : this.getBulletTypeByArms(upgradeArmsType);

          if (bulletType !== null) {
            this.startBulletPrewarm(bulletType, this.getWeaponPrewarmBulletCount());
          }

          var targetRoleType = this.getRoleTypeByWeaponConfig(weaponBulletConfig, upgradeArmsType);
        ...
        getWeaponModelArmsType(config, fallbackArmsType) {
          ...
          var modelType = config == null ? void 0 : config.weaponModel;
        ...
        applyWeaponRoleModel(config, fallbackArmsType) {
          var targetRoleType = this.getRoleTypeByWeaponConfig(config, fallbackArmsType);
        ...
        getWeaponBulletConfig(armwType, weaponBulletConfigIndex) {
          if (weaponBulletConfigIndex === void 0) {
            weaponBulletConfigIndex = -1;
          }

          var indexedConfig = this.getWeaponBulletConfigByIndex(weaponBulletConfigIndex);
        ...
        syncRoleAnimationToTeam(role) {
          ...
          for (var i = 0; i < this.roleList.length; i++) {
            var sourceRole = this.roleList[i];

            if (!sourceRole || sourceRole === role || sourceRole.attackIN || !sourceRole.fbxManager) {
              continue;
            }

            var sourceState = sourceRole.fbxManager.getAnimState(animName);
        ...
        canReserveRoleSlot(maxCount) {
          if (maxCount === void 0) {
            maxCount = this.getEffectiveMaxRoleCount();
          }

          var limit = Math.min(this.getEffectiveMaxRoleCount(), Math.max(1, Math.floor(maxCount)));
          return !this.isDie && this.roleList.length + this.pendingAddRoleCount < limit;
        }

        isRoleCountAtLimit(maxCount) {
          if (maxCount === void 0) {
            maxCount = this.getEffectiveMaxRoleCount();
          }
        ...
        reserveRoleSlot(maxCount) {
          ...
          var index = this.roleList.length + this.pendingAddRoleCount;
        ...
        replaceRoleWithCurrentType(role) {
          ...
          var parent = role.node.parent;
          var worldPos = (_crd && PoolManager === void 0 ? (_reportPossibleCrUseOfPoolManager({
            error: Error()
          ...
          var newRole = this.getRoleByType(this.roleType);
        ...
        getNextPos(index, local) {
          ...
          var effectiveIndex = index - 1;
          var layerInfo = this.getRoleLayerInfo(effectiveIndex);
        ...
        getRoleLayerInfo(effectiveIndex) {
          var layer = 0;
          var indexInLayer = Math.max(0, effectiveIndex);
          var layerCount = this.getRoleLayerCount(layer);
        ...
        applyRoleLayout(isDelayedShrink) {
          ...
          var _loop = function _loop() {
            ...
            if (!layoutIndex) {
              tween(role.node).to(_this.roleLayoutTweenDuration, {
                position: Vec3.ZERO
              }).start();
            } else {
              var pos = _this.getNextPos(layoutIndex, true);
        ...
        recycleOverflowRoles() {
          var maxCount = this.getEffectiveMaxRoleCount();

          for (var i = this.roleList.length - 1; i >= maxCount; i--) {
        ...
        hit(pos, count) {
          ...
          var candidateCount = 0; // 预分配距离数组，避免临时对象
          ...
          var len = count < candidateCount ? count : candidateCount;
        ...
        syncRespawnRoleCount() {
          ...
          var currentRoleCount = (_this$roleList$length = (_this$roleList = this.roleList) == null ? void 0 : _this$roleList.length) != null ? _this$roleList$length : 0;
      ...
      }), _descriptor11 = _applyDecoratedDescriptor(_class5.prototype, "outerLayerRoleCount", [_dec13], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor12 = _applyDecoratedDescriptor(_class5.prototype, "shrinkAfterRoleLossDelay", [_dec14], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor13 = _applyDecoratedDescriptor(_class5.prototype, "maxShootingRoleCount", [_dec15], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor14 = _applyDecoratedDescriptor(_class5.prototype, "maxMuzzleEffectCount", [_dec16], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor15 = _applyDecoratedDescriptor(_class5.prototype, "staggerShotWeaponConfigIndex", [_dec17], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor16 = _applyDecoratedDescriptor(_class5.prototype, "staggerShotWindowRatio", [_dec18], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor17 = _applyDecoratedDescriptor(_class5.prototype, "defaultWeaponConfigIndex", [_dec19], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor18 = _applyDecoratedDescriptor(_class5.prototype, "enableRuntimeUpgradePrewarm", [_dec20], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor19 = _applyDecoratedDescriptor(_class5.prototype, "weaponBulletConfigList", [_dec21], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor20 = _applyDecoratedDescriptor(_class5.prototype, "shootList", [_dec22], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
