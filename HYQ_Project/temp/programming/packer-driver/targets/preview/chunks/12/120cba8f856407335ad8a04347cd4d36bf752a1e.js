        ...
        upArms(armwType) {
          switch (armwType) {
            ...
            case (_crd && ArmsTypeEnum === void 0 ? (_reportPossibleCrUseOfArmsTypeEnum({
              ...
              var newRoleType = (_crd && RoleEnum === void 0 ? (_reportPossibleCrUseOfRoleEnum({
                error: Error()
              ...
              for (var i = 0; i < count; i++) {
                ...
                var newRole = this.getRoleByType(newRoleType);
            ...
            case (_crd && ArmsTypeEnum === void 0 ? (_reportPossibleCrUseOfArmsTypeEnum({
            ...
            }), ArmsTypeEnum) : ArmsTypeEnum).jtl2:
              {
                ...
                this.attackSpeed = 20;
                var _newRoleType = (_crd && RoleEnum === void 0 ? (_reportPossibleCrUseOfRoleEnum({
                  error: Error()
                }), RoleEnum) : RoleEnum).dazhuangPlus;
                this.roleType = _newRoleType;
                ...
                for (var _i = 0; _i < _count; _i++) {
                  ...
                  var _newRole = this.getRoleByType(_newRoleType);

                  this.roleList[_i] = _newRole;
                  this.node.addChild(_newRole.node);

                  _newRole.node.setPosition(_role.node.position);
