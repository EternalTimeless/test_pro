System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Collider2D, Contact2DType, BagBase, COLLIDE_TYPE, Shopping, BuyWayBase, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, BuyWay2D;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "ea9f8DZpdpNxZDp5NNbjQGm", "BuyWay2D", undefined);
      ...
      _export("BuyWay2D", BuyWay2D = (_dec = ccclass('BuyWay2D'), _dec2 = property(Collider2D), _dec(_class = (_class2 = class BuyWay2D extends (_crd && BuyWayBase === void 0 ? (_reportPossibleCrUseOfBuyWayBase({
        error: Error()
        ...
        onBeginContact(selfCollide, other, contcat) {
          var tag = other.tag;
          ...
          switch (tag) {
            case (_crd && COLLIDE_TYPE === void 0 ? (_reportPossibleCrUseOfCOLLIDE_TYPE({
              ...
              var shopping = other.getComponent(_crd && Shopping === void 0 ? (_reportPossibleCrUseOfShopping({
                error: Error()
              }), Shopping) : Shopping);
            ...
            case (_crd && COLLIDE_TYPE === void 0 ? (_reportPossibleCrUseOfCOLLIDE_TYPE({
              ...
              var bag = other.getComponent(_crd && BagBase === void 0 ? (_reportPossibleCrUseOfBagBase({
                error: Error()
              }), BagBase) : BagBase);
        ...
        onEndContact(selfCollide, other, contcat) {
          var tag = other.tag;
          ...
          switch (tag) {
            case (_crd && COLLIDE_TYPE === void 0 ? (_reportPossibleCrUseOfCOLLIDE_TYPE({
              ...
              var index = this.shopingList.indexOf(shopping);
            ...
            case (_crd && COLLIDE_TYPE === void 0 ? (_reportPossibleCrUseOfCOLLIDE_TYPE({
              ...
              var index2 = this.nBagArr.indexOf(bag);
...
//# sourceMappingURL=3b642f3c2b4a8e6deaa7e103aaa0f0178893f8bf.js.map