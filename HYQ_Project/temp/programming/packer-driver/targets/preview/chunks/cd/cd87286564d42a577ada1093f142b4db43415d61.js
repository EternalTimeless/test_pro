  ...
  return {
    ...
    execute: function () {
      ...
      _export("GuideLine", GuideLine = (_dec = ccclass('GuideLine'), _dec(_class = (_class2 = class GuideLine extends (_crd && UnityUpComponent === void 0 ? (_reportPossibleCrUseOfUnityUpComponent({
        ...
        _update(dt) {
          if (this._startNode) {
            var startPos = this._startNode.worldPosition;
            var endPos = this._endNode.worldPosition;
            this.temp1.set(startPos);
            this.temp1.y += 0.2;
            this.temp2.set(endPos);
            this.temp2.y += 0.2;
            var dis = Vec3.distance(startPos, endPos); // let count = Math.ceil(dis);
...
//# sourceMappingURL=cd87286564d42a577ada1093f142b4db43415d61.js.map