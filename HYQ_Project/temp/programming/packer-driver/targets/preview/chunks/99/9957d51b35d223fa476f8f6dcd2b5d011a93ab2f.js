    ...
    execute: function () {
      ...
      _export("BuyWay3D", BuyWay3D = (_dec = ccclass('BuyWay3D'), _dec2 = property(Collider), _dec(_class = (_class2 = class BuyWay3D extends (_crd && BuyWayBase === void 0 ? (_reportPossibleCrUseOfBuyWayBase({
        ...
        onBeginContact(event) {
          var tag = event.otherCollider.getComponent(_crd && ColliderTag === void 0 ? (_reportPossibleCrUseOfColliderTag({
            error: Error()
          ...
          switch (tag.tag) {
            case (_crd && COLLIDE_TYPE === void 0 ? (_reportPossibleCrUseOfCOLLIDE_TYPE({
              ...
              var shopping = event.otherCollider.getComponent(_crd && Shopping === void 0 ? (_reportPossibleCrUseOfShopping({
                error: Error()
              }), Shopping) : Shopping);
            ...
            case (_crd && COLLIDE_TYPE === void 0 ? (_reportPossibleCrUseOfCOLLIDE_TYPE({
              ...
              var bag = event.otherCollider.getComponent(_crd && BagBase === void 0 ? (_reportPossibleCrUseOfBagBase({
                error: Error()
              }), BagBase) : BagBase);
...
//# sourceMappingURL=9957d51b35d223fa476f8f6dcd2b5d011a93ab2f.js.map