    ...
    execute: function () {
      ...
      _export("JumpCurve3D", JumpCurve3D = class JumpCurve3D extends (_crd && JumpSequenceBase === void 0 ? (_reportPossibleCrUseOfJumpSequenceBase({
        ...
        init(jumpNode, endPos, jumpPower, jumpSpeed) {
          ...
          this._time = 0;
          var coe = this.solveQuadraticThroughPoints([jumpNode.worldPosition, endPos], jumpPower);
          this.a = coe.a;
          this.b = coe.b;
        ...
        move(dt) {
          ...
          var scaleT = -4 * this._time * this._time + 4 * this._time + 1;
          t *= scaleT * 1.5;
          this._time += t;
          this._time = Math.min(1, this._time);
          var pos = this.startPos;
          var x = this._time * this.dis;
          var y = this.a * x * x + this.b * x;

          if (this.curveRange) {
            var _cy = this.curveRange.curve.evaluate(this._time) * 4;
        ...
        solveQuadraticThroughPoints(point, direction) {
          ...
          var endtPoint = point[1];
          var x = endtPoint.x - startPoint.x;
          var z = endtPoint.z - startPoint.z;
          ...
          var d = startPoint.y - endtPoint.y;
          var ey = -d;
          var cy = 0;
          ...
          var x12 = -cx;
          var y12 = -cy;
          var x2233 = cx * cx - ex * ex;
          var x23 = cx - ex;
          var y23 = cy - ey;
          var b = (x1122 * y23 - y12 * x2233) / (x1122 * x23 - x2233 * x12);
          var a = (y12 - b * x12) / x1122;
          return {
            a,
            b
          };
...
//# sourceMappingURL=38483f6f68b174c6aad120536d38c3642cb0e458.js.map