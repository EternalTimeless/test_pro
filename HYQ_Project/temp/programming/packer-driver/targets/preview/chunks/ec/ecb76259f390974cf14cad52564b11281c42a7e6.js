    ...
    execute: function () {
      ...
      _export("JumpCurve", JumpCurve = class JumpCurve extends (_crd && JumpSequenceBase === void 0 ? (_reportPossibleCrUseOfJumpSequenceBase({
        ...
        move(dt) {
          ...
          var speed = this.data.fx * this._time;
          var x = this.startPosX + speed;
          var y = this.data.coe.a * x * x + this.data.coe.b * x + this.data.coe.c;

          if (this.curveRange) {
            var _cy = this.curveRange.curve.evaluate(this._time) * 256;
...
//# sourceMappingURL=ecb76259f390974cf14cad52564b11281c42a7e6.js.map