    ...
    execute: function () {
      ...
      _export("PropLalianGate", PropLalianGate = (_dec = ccclass('PropLalianGate'), _dec2 = property({
        ...
        getAuthoredSegmentCount() {
          ...
          var root = (_this$lalianRoot3 = this.lalianRoot) != null ? _this$lalianRoot3 : this.findNodeByName(this.node, 'Lalian');
        ...
        applySegmentProgress(segment, segmentIndex, progress, useTween, duration) {
          if (duration === void 0) {
