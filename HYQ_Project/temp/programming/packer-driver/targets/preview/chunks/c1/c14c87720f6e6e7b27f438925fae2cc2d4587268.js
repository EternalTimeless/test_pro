  ...
  return {
    ...
    execute: function () {
      ...
      _export("PropLalianGate", PropLalianGate = (_dec4 = ccclass('PropLalianGate'), _dec5 = property({
        ...
        type: CCFloat,
        displayName: '连续受击速度保留(0-1)',
        tooltip: '上一段摆动未结束时保留多少当前速度。0 表示只从当前姿态接新冲量，1 表示完整叠加旧速度；建议 0.25~0.5。'
      }), _dec27 = property({
        type: CCFloat,
        displayName: '拉环弹簧强度',
        ...
        tooltip: '控制前段速度回落的快慢。1 较平缓，2 会让前半段推进更快、前段回落更明显，之后持续平缓降速。建议 1~3。'
      }), _dec52 = property({
        type: CCFloat,
        displayName: '末段推进保留比例(0-1)',
        tooltip: '为后半段和结尾保留的基础推进速度。值越大越不容易拖尾；0.7 表示始终保留 70% 的基础推进。为避免最后一点长时间打不掉，建议保持 0.65~0.8。'
      }), _dec53 = property({
        type: CCInteger,
        displayName: '每对齿条数量',
        ...
        constructor() {
          ...
          _initializerDefineProperty(this, "pullRingSpringHitVelocityRetain", _descriptor24, this);

          _initializerDefineProperty(this, "pullRingSpringStiffness", _descriptor25, this);

          _initializerDefineProperty(this, "pullRingSpringDamping", _descriptor26, this);

          _initializerDefineProperty(this, "pullRingSpringRootMaxAngle", _descriptor27, this);

          _initializerDefineProperty(this, "pullRingSpringTailMaxAngle", _descriptor28, this);

          _initializerDefineProperty(this, "pullRingSpringTailReturnScale", _descriptor29, this);

          _initializerDefineProperty(this, "pullRingSpringSideSwingScale", _descriptor30, this);

          _initializerDefineProperty(this, "pullRingSpringSideLiftScale", _descriptor31, this);

          _initializerDefineProperty(this, "pullRingSpringRootUpMaxAngle", _descriptor32, this);

          _initializerDefineProperty(this, "pullRingSpringTailUpMaxAngle", _descriptor33, this);

          _initializerDefineProperty(this, "reversePullRingSideLift", _descriptor34, this);

          _initializerDefineProperty(this, "teethNodes", _descriptor35, this);

          _initializerDefineProperty(this, "autoCollectTeeth", _descriptor36, this);

          _initializerDefineProperty(this, "sortTeethByZ", _descriptor37, this);

          _initializerDefineProperty(this, "startFromMaxZ", _descriptor38, this);

          _initializerDefineProperty(this, "startFromFarthestSide", _descriptor39, this);

          _initializerDefineProperty(this, "startFromSliderSide", _descriptor40, this);

          _initializerDefineProperty(this, "reverseZOrder", _descriptor41, this);

          _initializerDefineProperty(this, "hpLabel", _descriptor42, this);

          _initializerDefineProperty(this, "nodeCount", _descriptor43, this);

          _initializerDefineProperty(this, "hitPerNode", _descriptor44, this);

          _initializerDefineProperty(this, "pairAdvancePerHit", _descriptor45, this);

          _initializerDefineProperty(this, "hitCountPerStep", _descriptor46, this);

          _initializerDefineProperty(this, "hitStageConfigList", _descriptor47, this);

          _initializerDefineProperty(this, "smoothTotalHitCount", _descriptor48, this);

          _initializerDefineProperty(this, "smoothProgressEasePower", _descriptor49, this);

          _initializerDefineProperty(this, "smoothEndSpeedFloor", _descriptor50, this);

          _initializerDefineProperty(this, "teethPerPair", _descriptor51, this);

          _initializerDefineProperty(this, "initialClosedPairCount", _descriptor52, this);

          _initializerDefineProperty(this, "nextPairInitialProgress", _descriptor53, this);

          _initializerDefineProperty(this, "nextNextPairInitialProgress", _descriptor54, this);

          _initializerDefineProperty(this, "nodeSpacingZ", _descriptor55, this);

          _initializerDefineProperty(this, "autoCloseCenterX", _descriptor56, this);

          _initializerDefineProperty(this, "closeCenterX", _descriptor57, this);

          _initializerDefineProperty(this, "closeX", _descriptor58, this);

          _initializerDefineProperty(this, "openOffsetX", _descriptor59, this);

          _initializerDefineProperty(this, "reverseOpenDirection", _descriptor60, this);

          _initializerDefineProperty(this, "propGapZ", _descriptor61, this);

          _initializerDefineProperty(this, "moveCount", _descriptor62, this);

          _initializerDefineProperty(this, "hitAnimTime", _descriptor63, this);

          _initializerDefineProperty(this, "cubeHideTime", _descriptor64, this);

          _initializerDefineProperty(this, "keepSliderZOffset", _descriptor65, this);

          _initializerDefineProperty(this, "sliderOffsetZ", _descriptor66, this);

          _initializerDefineProperty(this, "reverseSliderMoveZ", _descriptor67, this);

          _initializerDefineProperty(this, "bulletLockRangeX", _descriptor68, this);

          _initializerDefineProperty(this, "bulletAimShrink", _descriptor69, this);

          _initializerDefineProperty(this, "bulletAimFrontDepthRatio", _descriptor70, this);

          _initializerDefineProperty(this, "hitAreaOffsetZ", _descriptor71, this);

          _initializerDefineProperty(this, "useCubeBoundsHitCenter", _descriptor72, this);

          _initializerDefineProperty(this, "sliderHitPaddingX", _descriptor73, this);

          _initializerDefineProperty(this, "sliderHitPaddingZ", _descriptor74, this);

          _initializerDefineProperty(this, "sliderThickCenterBias", _descriptor75, this);
        ...
        playHitStep() {
          ...
          var sliderTarget = this.getSmoothSliderTargetPos(smoothProgress);
          var targetPos = sliderTarget ? this.getForwardOnlySliderTargetPos(sliderTarget) : null;
        ...
        applyInitialProgress() {
          ...
          if (this.cube && targetPos) {
            ...
            var startY = targetPos.y;
            var startZ = targetPos.z;
            var endTargetPos = this.getSmoothSliderTargetPos(1);
        ...
        getForwardOnlySliderTargetPos(targetPos) {
          ...
          if (this.sliderForwardZSign !== 0) {
            var zDelta = this.tempForwardSliderTargetPos.z - this.sliderLastTargetPos.z;
        ...
        applyWholeSmoothProgress(progress, useTween, duration) {
          ...
          for (var i = 0; i < this.pairCount; i++) {
            ...
            var clampedPairProgress = this.getClampedProgress(pairProgress);
            var previousPairProgress = (_this$pairProgressLis = this.pairProgressList[i]) != null ? _this$pairProgressLis : 0;
            var shouldTweenPair = useTween && clampedPairProgress > previousPairProgress + 0.0001;
        ...
        randomizePullRingTailTweenSwing() {
          var randomRate = this.getPullRingTailRandomSwingRate();
        ...
        kickPullRingSpring() {
          ...
          var direction = this.getNextPullRingSpringSwingDirection();

          if (this.isPullRingRootSpringEnabled()) {
            var rootRate = this.getPullRingRootSpringRate();
            var rootImpulseY = direction * this.getPullRingSpringRootImpulseY() * rootRate;
            var rootImpulseX = this.getPullRingSpringRootImpulseX() * rootRate;
            this.pullRingSpringRootVelY = this.blendPullRingSpringVelocity(this.pullRingSpringRootVelY, rootImpulseY, this.pullRingSpringRootAngleY, -this.getPullRingSpringRootMaxY(), this.getPullRingSpringRootMaxY(), this.getPullRingSpringRootImpulseY() * rootRate * 1.35);
            this.pullRingSpringRootVelX = this.blendPullRingSpringVelocity(this.pullRingSpringRootVelX, rootImpulseX, this.pullRingSpringRootAngleX, -this.getPullRingSpringRootMaxX() * 0.35, this.getPullRingSpringRootMaxX(), this.getPullRingSpringRootImpulseX() * rootRate * 1.35);
          }

          var tailRandomMaxScale = 1 + this.getPullRingTailRandomSwingRate();
          var tailImpulseY = this.getRandomPullRingTailSpringSwingImpulse(direction);
          var tailImpulseX = this.getRandomPullRingTailSpringLiftImpulse();
          this.pullRingSpringTailVelY = this.blendPullRingSpringVelocity(this.pullRingSpringTailVelY, tailImpulseY, this.pullRingSpringTailAngleY, -this.getPullRingSpringTailMaxY(), this.getPullRingSpringTailMaxY(), this.getPullRingSpringTailImpulseY() * tailRandomMaxScale * 1.35);
          this.pullRingSpringTailVelX = this.blendPullRingSpringVelocity(this.pullRingSpringTailVelX, tailImpulseX, this.pullRingSpringTailAngleX, -this.getPullRingSpringTailMaxX() * 0.25, this.getPullRingSpringTailMaxX(), this.getPullRingSpringTailImpulseX() * tailRandomMaxScale * 1.35);
        ...
        updatePullRingSpring(dt) {
          ...
          var stepDt = Math.max(0, Math.min(0.033, dt)) * this.getPullRingSwingSpeedScale();
        ...
        getPullRingTailStepEuler(stepIndex, useRandom) {
          if (useRandom === void 0) {
            useRandom = false;
          }

          var phase = this.getPullRingPhase(stepIndex) + (useRandom ? this.pullRingTailTweenRandomPhase : 0);
          ...
          var swingScale = useRandom ? this.pullRingTailTweenRandomSwingScale : 1;
          var liftScale = useRandom ? this.pullRingTailTweenRandomLiftScale : 1;
          var swingY = this.clampSigned(wave * this.pullRingTailSwingY * swingScale, this.getPullRingSpringTailMaxY());
          var liftX = this.clampRange(liftCurve * this.pullRingTailLiftX * downAngleScale * liftScale, -this.getPullRingSpringTailUpMaxAngle(), this.getPullRingSpringTailMaxX());
        ...
        getPullRingSpringHitVelocityRetain() {
        ...
        getNextPullRingSpringSwingDirection() {
          var maxY = this.getPullRingSpringTailMaxY();
          var edgeThreshold = maxY * 0.65;
        ...
        getRandomPullRingTailSpringSwingImpulse(direction) {
          var baseImpulse = this.getPullRingSpringTailImpulseY();
          var randomRate = this.getPullRingTailRandomSwingRate();
        ...
        getRandomPullRingTailSpringLiftImpulse() {
          var baseImpulse = this.getPullRingSpringTailImpulseX();
          var randomRate = this.getPullRingTailRandomSwingRate();
        ...
        blendPullRingSpringVelocity(currentVelocity, impulse, angle, minAngle, maxAngle, velocityLimit) {
          var retain = this.getPullRingSpringHitVelocityRetain();
          var retainedHeadroom = this.getPullRingSpringImpulseHeadroom(angle, currentVelocity, minAngle, maxAngle);
          var impulseHeadroom = this.getPullRingSpringImpulseHeadroom(angle, impulse, minAngle, maxAngle);
          var nextVelocity = currentVelocity * retain * retainedHeadroom + impulse * impulseHeadroom;
          return this.clampSigned(nextVelocity, Math.max(1, velocityLimit));
        }

        getPullRingSpringImpulseHeadroom(angle, velocity, minAngle, maxAngle) {
          if (velocity === 0 || maxAngle <= minAngle) {
            return 1;
          }

          var distanceToLimit = velocity > 0 ? maxAngle - angle : angle - minAngle;
          var halfRange = (maxAngle - minAngle) * 0.5;
        ...
        getSmoothWholeProgress(linearProgress) {
          ...
          var decayStrength = Math.max(0.01, this.smoothProgressEasePower * 4);
          var speedFloor = this.getClampedProgress(this.smoothEndSpeedFloor);
          var earlyBoost = (1 - speedFloor) * (1 - Math.exp(-decayStrength * clampedProgress)) * (1 - clampedProgress);
          var progress = clampedProgress + earlyBoost;
      ...
      }), _descriptor24 = _applyDecoratedDescriptor(_class5.prototype, "pullRingSpringHitVelocityRetain", [_dec26], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor25 = _applyDecoratedDescriptor(_class5.prototype, "pullRingSpringStiffness", [_dec27], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor26 = _applyDecoratedDescriptor(_class5.prototype, "pullRingSpringDamping", [_dec28], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor27 = _applyDecoratedDescriptor(_class5.prototype, "pullRingSpringRootMaxAngle", [_dec29], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor28 = _applyDecoratedDescriptor(_class5.prototype, "pullRingSpringTailMaxAngle", [_dec30], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor29 = _applyDecoratedDescriptor(_class5.prototype, "pullRingSpringTailReturnScale", [_dec31], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor30 = _applyDecoratedDescriptor(_class5.prototype, "pullRingSpringSideSwingScale", [_dec32], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor31 = _applyDecoratedDescriptor(_class5.prototype, "pullRingSpringSideLiftScale", [_dec33], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor32 = _applyDecoratedDescriptor(_class5.prototype, "pullRingSpringRootUpMaxAngle", [_dec34], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor33 = _applyDecoratedDescriptor(_class5.prototype, "pullRingSpringTailUpMaxAngle", [_dec35], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor34 = _applyDecoratedDescriptor(_class5.prototype, "reversePullRingSideLift", [_dec36], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor35 = _applyDecoratedDescriptor(_class5.prototype, "teethNodes", [_dec37], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor36 = _applyDecoratedDescriptor(_class5.prototype, "autoCollectTeeth", [_dec38], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor37 = _applyDecoratedDescriptor(_class5.prototype, "sortTeethByZ", [_dec39], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor38 = _applyDecoratedDescriptor(_class5.prototype, "startFromMaxZ", [_dec40], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor39 = _applyDecoratedDescriptor(_class5.prototype, "startFromFarthestSide", [_dec41], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor40 = _applyDecoratedDescriptor(_class5.prototype, "startFromSliderSide", [_dec42], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor41 = _applyDecoratedDescriptor(_class5.prototype, "reverseZOrder", [_dec43], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor42 = _applyDecoratedDescriptor(_class5.prototype, "hpLabel", [_dec44], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor43 = _applyDecoratedDescriptor(_class5.prototype, "nodeCount", [_dec45], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor44 = _applyDecoratedDescriptor(_class5.prototype, "hitPerNode", [_dec46], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor45 = _applyDecoratedDescriptor(_class5.prototype, "pairAdvancePerHit", [_dec47], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor46 = _applyDecoratedDescriptor(_class5.prototype, "hitCountPerStep", [_dec48], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor47 = _applyDecoratedDescriptor(_class5.prototype, "hitStageConfigList", [_dec49], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor48 = _applyDecoratedDescriptor(_class5.prototype, "smoothTotalHitCount", [_dec50], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor49 = _applyDecoratedDescriptor(_class5.prototype, "smoothProgressEasePower", [_dec51], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor50 = _applyDecoratedDescriptor(_class5.prototype, "smoothEndSpeedFloor", [_dec52], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor51 = _applyDecoratedDescriptor(_class5.prototype, "teethPerPair", [_dec53], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor52 = _applyDecoratedDescriptor(_class5.prototype, "initialClosedPairCount", [_dec54], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor53 = _applyDecoratedDescriptor(_class5.prototype, "nextPairInitialProgress", [_dec55], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor54 = _applyDecoratedDescriptor(_class5.prototype, "nextNextPairInitialProgress", [_dec56], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor55 = _applyDecoratedDescriptor(_class5.prototype, "nodeSpacingZ", [_dec57], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor56 = _applyDecoratedDescriptor(_class5.prototype, "autoCloseCenterX", [_dec58], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor57 = _applyDecoratedDescriptor(_class5.prototype, "closeCenterX", [_dec59], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor58 = _applyDecoratedDescriptor(_class5.prototype, "closeX", [_dec60], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor59 = _applyDecoratedDescriptor(_class5.prototype, "openOffsetX", [_dec61], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor60 = _applyDecoratedDescriptor(_class5.prototype, "reverseOpenDirection", [_dec62], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor61 = _applyDecoratedDescriptor(_class5.prototype, "propGapZ", [_dec63], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor62 = _applyDecoratedDescriptor(_class5.prototype, "moveCount", [_dec64], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor63 = _applyDecoratedDescriptor(_class5.prototype, "hitAnimTime", [_dec65], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor64 = _applyDecoratedDescriptor(_class5.prototype, "cubeHideTime", [_dec66], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor65 = _applyDecoratedDescriptor(_class5.prototype, "keepSliderZOffset", [_dec67], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor66 = _applyDecoratedDescriptor(_class5.prototype, "sliderOffsetZ", [_dec68], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor67 = _applyDecoratedDescriptor(_class5.prototype, "reverseSliderMoveZ", [_dec69], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor68 = _applyDecoratedDescriptor(_class5.prototype, "bulletLockRangeX", [_dec70], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor69 = _applyDecoratedDescriptor(_class5.prototype, "bulletAimShrink", [_dec71], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor70 = _applyDecoratedDescriptor(_class5.prototype, "bulletAimFrontDepthRatio", [_dec72], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor71 = _applyDecoratedDescriptor(_class5.prototype, "hitAreaOffsetZ", [_dec73], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor72 = _applyDecoratedDescriptor(_class5.prototype, "useCubeBoundsHitCenter", [_dec74], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor73 = _applyDecoratedDescriptor(_class5.prototype, "sliderHitPaddingX", [_dec75], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor74 = _applyDecoratedDescriptor(_class5.prototype, "sliderHitPaddingZ", [_dec76], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor75 = _applyDecoratedDescriptor(_class5.prototype, "sliderThickCenterBias", [_dec77], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
