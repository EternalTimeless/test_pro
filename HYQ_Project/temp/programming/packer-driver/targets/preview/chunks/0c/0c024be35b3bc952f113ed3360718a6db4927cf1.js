    ...
    execute: function () {
      ...
      _export("default", BulletBattle2D = (_dec = ccclass('BulletBattle2D'), _dec2 = property({
        ...
        setBulletInfo(angle, damage, repelPower) {
          ...
          var vectorX = Math.cos(r);
          var vectorY = Math.sin(r);
        ...
        _startCollide(other) {
          ...
          var battle = other.node.getComponent(_crd && BattleTarget3D === void 0 ? (_reportPossibleCrUseOfBattleTarget3D({
            error: Error()
...
//# sourceMappingURL=0c024be35b3bc952f113ed3360718a6db4927cf1.js.map