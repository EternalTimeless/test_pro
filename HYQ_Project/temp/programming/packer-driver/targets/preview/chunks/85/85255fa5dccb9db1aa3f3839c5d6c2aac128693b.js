        ...
        upArms(armwType) {
          switch (armwType) {
            ...
            case (_crd && ArmsTypeEnum === void 0 ? (_reportPossibleCrUseOfArmsTypeEnum({
              ...
              var count = this.roleList.length;
              ...
              for (var i = 0; i < count; i++) {
                var role = this.roleList[i];
                var newRole = (_crd && PrefabsManager === void 0 ? (_reportPossibleCrUseOfPrefabsManager({
                  error: Error()
            ...
            case (_crd && ArmsTypeEnum === void 0 ? (_reportPossibleCrUseOfArmsTypeEnum({
            ...
            }), ArmsTypeEnum) : ArmsTypeEnum).jtl2:
              {
                ...
                var _count = this.roleList.length;
                (_crd && TweenTool === void 0 ? (_reportPossibleCrUseOfTweenTool({
                  error: Error()
                }), TweenTool) : TweenTool).scaleShake(this.node);
                this.roleR = 1;
                ...
                for (var _i = 0; _i < _count; _i++) {
                  ...
                  var _newRole = (_crd && PrefabsManager === void 0 ? (_reportPossibleCrUseOfPrefabsManager({
                    error: Error()
                  }), PrefabsManager) : PrefabsManager).instance.GetPrefabsIns((_crd && PrefabsEnum === void 0 ? (_reportPossibleCrUseOfPrefabsEnum({
                    error: Error()
                  }), PrefabsEnum) : PrefabsEnum).hero, this.roleType);

                  this.roleList[_i] = _newRole.getComponent(_crd && Role === void 0 ? (_reportPossibleCrUseOfRole({
                    error: Error()
                  }), Role) : Role);
                  this.node.addChild(_newRole);

                  _newRole.setPosition(_role.node.position);

                  _role.node.active = false;
                }
        ...
        roleMove() {
          ...
          if (this.isLock) {
            ...
            for (var _i2 = 0; _i2 < this.roleList.length; _i2++) {
              ...
              if (isMove) {
                _role2.fbxManager.setAnimation(PlayerFBXAnimName.run, true);
              } else {
                _role2.fbxManager.setAnimation(PlayerFBXAnimName.idle, true);
              }
            }
          }
        }
        ...
        upPos() {
          ...
          var _loop = function _loop() {
            ...
            if (!_i3) {
              ...
              var pos = _this.getNextPos(_i3, true);
...
//# sourceMappingURL=85255fa5dccb9db1aa3f3839c5d6c2aac128693b.js.map