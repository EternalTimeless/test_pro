    ...
    execute: function () {
      ...
      _export("MonsterCreate", MonsterCreate = (_dec14 = ccclass('MonsterCreate'), _dec15 = property({
        ...
        getMonsterCollisionHalfZ(monster) {
          ...
          const minHalfZ = (monster == null ? void 0 : monster.monsterType) === (_crd && MonsterType === void 0 ? (_reportPossibleCrUseOfMonsterType({
            error: Error()
        ...
        restoreWaveRolesAfterRebirth(rebirthLayout) {
          ...
          for (let i = 0; i < this._waveRoleNodes.length; i++) {
            ...
            role.node.active = true;
            const targetWaveIndex = (_this$_waveStageIndex2 = this._waveStageIndexList[i]) != null ? _this$_waveStageIndex2 : i;
            const frontMonster = rebirthLayout ? this.getFrontMonsterByWaveLayout(targetWaveIndex, rebirthLayout) : this.getFrontMonsterByWave(targetWaveIndex);
