      ...
      _export("MoveDrive", MoveDrive = (_dec = ccclass('MoveDrive'), _dec2 = property(Vec3), _dec3 = property({
        ...
        rockerMove(dt) {
          if ((_crd && RockerManager === void 0 ? (_reportPossibleCrUseOfRockerManager({
            ...
            let rocker = (_crd && RockerManager === void 0 ? (_reportPossibleCrUseOfRockerManager({
              error: Error()
        ...
        PosMove(dt) {
          ...
          if (disSq < this.dis * this.dis || disSq <= frameDistSq) {
            ...
            let vector = (_crd && vectorMoveSpeed === void 0 ? (_reportPossibleCrUseOfvectorMoveSpeed({
              error: Error()
        ...
        targetMove(dt) {
          if (this.target == null) {
            ...
            if (disSq < this.dis * this.dis || disSq <= frameDistSq) {
              ...
              let vector = (_crd && vectorPower === void 0 ? (_reportPossibleCrUseOfvectorPower({
                error: Error()
        ...
        aStarMove(deltaTime) {
          ...
          let vector = (_crd && vectorPower2 === void 0 ? (_reportPossibleCrUseOfvectorPower2({
            error: Error()
...
//# sourceMappingURL=b126fde6e2388056fd915ab16a9e302cdac3611d.js.map