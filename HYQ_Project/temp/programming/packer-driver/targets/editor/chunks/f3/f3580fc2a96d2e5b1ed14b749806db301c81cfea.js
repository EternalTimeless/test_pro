  ...
  return {
    ...
    execute: function () {
      ...
      _export("default", PropManager = class PropManager extends (_crd && Singleton === void 0 ? (_reportPossibleCrUseOfSingleton({
        ...
        getProp(id) {
          let prop = (_crd && PoolManager === void 0 ? (_reportPossibleCrUseOfPoolManager({
            error: Error()
        ...
        createProp(pos, count, propId) {
          ...
          for (let i = 0; i < count; i++) {
            ...
            let endpos = (_crd && getPosRandomPos === void 0 ? (_reportPossibleCrUseOfgetPosRandomPos({
              error: Error()
...
//# sourceMappingURL=f3580fc2a96d2e5b1ed14b749806db301c81cfea.js.map