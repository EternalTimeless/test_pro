  ...
  return {
    ...
    execute: function () {
      ...
      _export("default", TweenTool = class TweenTool {
        static scaleShake(node, delay = 0, time = 0.1, off = Vec3.ONE) {
        ...
        static scaleShake2(node, delay = 0, time = 0.1, off = Vec3.ONE) {
          this.temp.set(node.scale);
          let scale = this.temp.clone();
          let scaleOffX;
          let scaleOffY;
        ...
        static beatAni(node, s, off = 0.15, callback = null) {
          let v2 = new Vec3(s, s);
        ...
        static beatAni2(node, ss, es, intervalTime = 0.1) {
          let ess = es;
        ...
        static move(node, endPos, time, callback = null) {
          tween(node).to(time, {
            position: endPos
          }).call(() => {
        ...
        static scale(node, startScale, endScale, intervalTime, repeatTime = 1, callback = null) {
        ...
        static jumpMove(node, endPos, time, callback, jumpHeight = 100) {
        ...
        static spFlashColor(sp, intervalTime, repeatTime = 1, flashColor = new Color(255, 0, 0, 255)) {
        ...
        static shakeNode(node, tweenDuration = 0.02, repeatTime = 1, shakeScale = 1) {
          let startPos = node.position.clone();
          let posArray = [new Vec3(5, 7, 0), new Vec3(-6, 7, 0), new Vec3(-13, 3, 0), new Vec3(3, -6, 0), new Vec3(-5, 5, 0), new Vec3(2, -8, 0), new Vec3(-8, -10, 0), new Vec3(3, 10, 0)];
          ...
          let t = tween(node).to(tweenDuration, {
            position: posArray[0]
          }).to(tweenDuration, {
            position: posArray[1]
          }).to(tweenDuration, {
        ...
        static jumpScale(node, delay = 0, height = 1.2) {
...
//# sourceMappingURL=b8ad0522613130e3b3bc0faa3ce99aed072678c6.js.map