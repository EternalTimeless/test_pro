      ...
      _export("MonsterBattleTaerget", MonsterBattleTaerget = (_dec = ccclass('MonsterBattleTaerget'), _dec2 = property({
        ...
        refreshPlayerFormationCache() {
          ...
          for (let i = 0; i < player.roleList.length; i++) {
            ...
            const attackZ = (_role$shoot = role.shoot) != null && _role$shoot.isValid ? role.shoot.worldPosition.z : role.node.worldPosition.z;
        ...
        updateRunAnimationLod() {
          ...
          const isRunAnimation = !!((_this$fbx5 = this.fbx) != null && _this$fbx5.isCurAnimation(MonsterAnimEnum.run));
          ...
          if ((frame + this.animationLodPhase) % visibilityInterval === 0) {
            ...
            const camera = (_instance2 = (_crd && CameraMove === void 0 ? (_reportPossibleCrUseOfCameraMove({
              error: Error()
