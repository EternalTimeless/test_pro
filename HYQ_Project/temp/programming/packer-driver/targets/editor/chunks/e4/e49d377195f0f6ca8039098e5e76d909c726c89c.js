    ...
    execute: function () {
      ...
      _export("RockerMouseEvent", RockerMouseEvent = (_dec = ccclass('RockerMouseEvent'), _dec2 = property(_crd && RockerUI === void 0 ? (_reportPossibleCrUseOfRockerUI({
        ...
        onMouseDown(event) {
          ...
          const camera = (_crd && CameraMove === void 0 ? (_reportPossibleCrUseOfCameraMove({
            error: Error()
        ...
        onMouseMove(event) {
          ...
          let x = this._downPos.x - this._tempV3.x; // let X = x / Math.abs(x);
...
//# sourceMappingURL=e49d377195f0f6ca8039098e5e76d909c726c89c.js.map