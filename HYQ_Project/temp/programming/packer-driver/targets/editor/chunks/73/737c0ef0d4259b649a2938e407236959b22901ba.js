System.register(["cc", "__unresolved_0"], function (_export, _context) {
  ...
  var _cclegacy, StutterCheck, PrintComponent, PlayerAction, EventName;
  ...
  return {
    setters: [function (_cc) {
      ...
      StutterCheck = _unresolved_.default;
    }],
    execute: function () {
      ...
      _export("PrintComponent", PrintComponent = class PrintComponent {
        ...
        static init(material, maxStage = 1) {
          //初始化
        ...
        static reportEvent(eventType, additionalParams = {}) {
          let params = {
            ...
            'user_id': this.userId,
            'uuid': this.uuid,
            ...additionalParams //  'debug_mode': true
...
//# sourceMappingURL=737c0ef0d4259b649a2938e407236959b22901ba.js.map