      ...
      _export("PropLalianGate", PropLalianGate = (_dec4 = ccclass('PropLalianGate'), _dec5 = property({
        ...
        playHitStep() {
          ...
          if (!stepCompleted) {
            ...
            const targetTooth = (_this$getSliderPairLe = this.getSliderPairLeadTooth(nextPairState)) != null ? _this$getSliderPairLe : closeTooth;
        ...
        applyInitialProgress() {
          ...
          this.stepHitCount = 0;
          this.toothIndex = this.getPairStartToothIndex(this.pairIndex);
          const sliderTooth = (_this$getSliderPairLe2 = this.getSliderPairLeadTooth(this.pairIndex)) != null ? _this$getSliderPairLe2 : this.teeth[0];
