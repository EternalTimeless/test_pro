        ...
        onBeginContact(selfCollide, other, contcat) {
          ...
          switch (tag) {
            case (_crd && COLLIDE_TYPE === void 0 ? (_reportPossibleCrUseOfCOLLIDE_TYPE({
              ...
              let shopping = other.getComponent(_crd && Shopping === void 0 ? (_reportPossibleCrUseOfShopping({
                error: Error()
              }), Shopping) : Shopping);
            ...
            case (_crd && COLLIDE_TYPE === void 0 ? (_reportPossibleCrUseOfCOLLIDE_TYPE({
              ...
              let bag = other.getComponent(_crd && BagBase === void 0 ? (_reportPossibleCrUseOfBagBase({
                error: Error()
              }), BagBase) : BagBase);
