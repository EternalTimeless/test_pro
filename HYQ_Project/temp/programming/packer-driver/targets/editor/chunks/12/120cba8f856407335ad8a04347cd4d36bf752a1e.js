      ...
      _export("Player", Player = (_dec9 = ccclass('Player'), _dec10 = property(_crd && Role === void 0 ? (_reportPossibleCrUseOfRole({
        ...
        processPendingRoleSwitch() {
          ...
          while (count > 0 && this.pendingRoleSwitchIndex < this.roleList.length) {
            ...
            const newRole = this.enableRuntimeUpgradePrewarm ? this.getPooledRoleByType(this.pendingRoleSwitchType) : this.getRoleByType(this.pendingRoleSwitchType);
        ...
        addRole(role, attackIn = true, refreshShadow = true) {
          if (this.isDie) {
            return false;
          }
        ...
        refreshRoleShadowCasting() {
          ...
          const onlyOuterLayer = this.onlyOuterLayerCastShadow || ((_director$getScene = director.getScene()) == null ? void 0 : _director$getScene.name) === 'Game_3D-002';
        ...
        getPooledRoleByType(roleType) {
          const role = (_crd && PoolManager === void 0 ? (_reportPossibleCrUseOfPoolManager({
            error: Error()
