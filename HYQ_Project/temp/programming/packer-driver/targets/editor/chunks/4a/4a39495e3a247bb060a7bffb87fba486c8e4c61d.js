  ...
  return {
    ...
    execute: function () {
      ...
      _export("CollectBattleTarger2D", CollectBattleTarger2D = (_dec = ccclass('CollectBattleTarger2D'), _dec(_class = class CollectBattleTarger2D extends (_crd && TriggerBase2D === void 0 ? (_reportPossibleCrUseOfTriggerBase2D({
        ...
        _startCollide(other) {
          let battle = other.getComponent(_crd && BattleTarget2D === void 0 ? (_reportPossibleCrUseOfBattleTarget2D({
            error: Error()
...
//# sourceMappingURL=4a39495e3a247bb060a7bffb87fba486c8e4c61d.js.map