System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Collider, Component, RigidBody, ColliderTag, COLLIDE_TYPE, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, BulletCollideBase3D;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      ColliderTag = _unresolved_2.default;
      COLLIDE_TYPE = _unresolved_2.COLLIDE_TYPE;
    }],
    execute: function () {
      _crd = true;

      _cclegacy._RF.push({}, "8ca3dTwcBVMPYRMibhAwJ4X", "BulletCollideBase3D", undefined);

      __checkObsolete__(['_decorator', 'CCInteger', 'CircleCollider2D', 'Collider', 'Collider2D', 'Component', 'Contact2DType', 'game', 'IPhysics2DContact', 'ITriggerEvent', 'Node', 'RigidBody', 'RigidBody2D', 'sp']);
      ...
      _export("BulletCollideBase3D", BulletCollideBase3D = (_dec = ccclass('BulletCollideBase3D'), _dec2 = property({
        type: _crd && COLLIDE_TYPE === void 0 ? (_reportPossibleCrUseOfCOLLIDE_TYPE({
          error: Error()
        }), COLLIDE_TYPE) : COLLIDE_TYPE
      }), _dec(_class = (_class2 = class BulletCollideBase3D extends Component {
        constructor(...args) {
          super(...args);
        ...
        onStartCollide(event) {
          let colliderTag = event.otherCollider.getComponent(_crd && ColliderTag === void 0 ? (_reportPossibleCrUseOfColliderTag({
            error: Error()
...
//# sourceMappingURL=7a056ac353cd4f184635b76aa08c0d427085fda7.js.map