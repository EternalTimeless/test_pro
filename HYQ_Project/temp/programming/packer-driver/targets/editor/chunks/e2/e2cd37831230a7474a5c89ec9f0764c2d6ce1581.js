      ...
      _export("CreatePropBrand", CreatePropBrand = (_dec = ccclass('CreatePropBrand'), _dec2 = property(CCInteger), _dec3 = property(CCFloat), _dec4 = property(CCFloat), _dec5 = property(CCInteger), _dec6 = property(CCFloat), _dec7 = property(_crd && PropArms === void 0 ? (_reportPossibleCrUseOfPropArms({
        ...
        setWaveRoleList(nodes) {
          ...
          for (let i = 0; i < nextRoleList.length; i++) {
            ...
            (_nextRoleList$i = nextRoleList[i]) == null || _nextRoleList$i.node.on((_crd && EventType === void 0 ? (_reportPossibleCrUseOfEventType({
              error: Error()
            }), EventType) : EventType).PROP_ARMS_DIE, this.armsUPEvent, this);
          }
        }
        ...
        start() {
          ...
          for (let i = 0; i < roleList.length; i++) {
            var _roleList$i, _roleList$i2;

            (_roleList$i = roleList[i]) == null || _roleList$i.node.off((_crd && EventType === void 0 ? (_reportPossibleCrUseOfEventType({
              error: Error()
            }), EventType) : EventType).PROP_ARMS_DIE, this.armsUPEvent, this);
            (_roleList$i2 = roleList[i]) == null || _roleList$i2.node.on((_crd && EventType === void 0 ? (_reportPossibleCrUseOfEventType({
              error: Error()
            }), EventType) : EventType).PROP_ARMS_DIE, this.armsUPEvent, this);
          }
        }
        ...
        onDestroy() {
          ...
          for (let i = 0; i < roleList.length; i++) {
            ...
            (_roleList$i3 = roleList[i]) == null || _roleList$i3.node.off((_crd && EventType === void 0 ? (_reportPossibleCrUseOfEventType({
              error: Error()
            }), EventType) : EventType).PROP_ARMS_DIE, this.armsUPEvent, this);
          }
        }
