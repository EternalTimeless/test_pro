    ...
    execute: function () {
      ...
      _export("CreatePropBrand", CreatePropBrand = (_dec = ccclass('CreatePropBrand'), _dec2 = property({
        ...
        getMaxFeedbackWorldPos(player) {
          ...
          const sourcePos = (_centerRole$node$worl = centerRole == null || (_centerRole$node = centerRole.node) == null ? void 0 : _centerRole$node.worldPosition) != null ? _centerRole$node$worl : player.node.worldPosition;
        ...
        findLalianGate(root) {
          ...
          const gate = root.getComponent(_crd && PropLalianGate === void 0 ? (_reportPossibleCrUseOfPropLalianGate({
            error: Error()
          }), PropLalianGate) : PropLalianGate);
