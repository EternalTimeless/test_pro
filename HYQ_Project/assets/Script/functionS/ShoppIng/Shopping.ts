...
export const SHOP_EVENT: string = "SHOP_EVENT_MoneyAccount";
...
export default class Shopping extends Component {
    ...
    @property(Node)
    private _guideNode: Node;


    @property(Node)
    public set guideNode(value: Node) {
        this._guideNode = value;
    }
    public get guideNode() {
    ...
    public get shopScale() {
        const scale = this._gold / this.gold;
        if (scale) {
            return 1 - scale;
        }
        return 0;
