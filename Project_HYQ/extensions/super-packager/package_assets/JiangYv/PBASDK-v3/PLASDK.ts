...
export enum PLASDK_EVENT {
    ...
    CHALLENGE_PASS_25 = 'CHALLENGE_PASS_25',    // 自动打点 玩30s
    CHALLENGE_PASS_50 = 'CHALLENGE_PASS_50',    // 自动打点 玩60s
    CHALLENGE_PASS_75 = 'CHALLENGE_PASS_75',    // 自动打点 玩90s
    CHALLENGE_SOLVED = 'CHALLENGE_SOLVED',

    COMPLETED = 'COMPLETED',            // 弹出落版
