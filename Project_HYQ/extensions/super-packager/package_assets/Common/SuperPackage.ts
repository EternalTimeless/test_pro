...
export class SuperPackage {
     ...
     */
    private _google_play_url: string = "https://play.google.com/store/apps/details?id=com.funfizz.palmon.gp";
    /**
     * 苹果链接（打包工具中设置会自动同步到这里）
     */
    private _appstore_url: string = "https://apps.apple.com/app/palmon-survival/id6739345737";
