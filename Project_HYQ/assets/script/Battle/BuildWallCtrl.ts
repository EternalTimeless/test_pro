import { _decorator, CCBoolean, CCFloat, Collider, Node, Vec3, v3, easing, Tween, tween } from 'cc';
...
/**单段墙体 */
@ccclass('BuildWallCtrl')
export class BuildWallCtrl extends CharacterBase {
